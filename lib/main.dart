...
import 'package:tok_tik/presentation/screens/discover/dicover_screen.dart';
    ...
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(
          lazy: false,
          create: (_) => DiscoverProvider(videoPostRepository: videoPostRepository)..liadNextPage()),
      ],
      child: MaterialApp(
        title: 'Material App',
